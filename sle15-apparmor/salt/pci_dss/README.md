...
- categories: sysctl, packages, rpm, services, permissions, kernel_modules, sshd, lineinfile, accounts, pam, sudo, audit, dconf, coredump, grub, firewall, limits, aide, mac
