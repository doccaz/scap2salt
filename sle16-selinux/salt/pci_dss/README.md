...
Coverage: **203/243** remediable rules mapped to native Salt (84%).
40 unmapped (`UNMAPPED.md`); 18 ship no remediation (`NO_REMEDIATION.md`); 1 not applicable to this MAC (`SKIPPED_NA.md`).
